...
$result_lietke_sp = $db->prepare($sql_lietke_sp);
$result_lietke_sp->execute();
?>
...
<table style="width: 100%;" border="1" style="border-collapse:collapse;">
    ...
    ?>
        <tr>
            ...
            <td>
                <a class="btn btn-primary mx-2" href="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>">Xóa</a>|
