 ...
 <table border="1" width="50%" style="border-collapse: collapse;">
   <form method="POST" action="modules/quanlysp/xuly.php" enctype="multipart/form-data">
        ...
        <td>
          <select name="danhmuc">
                <?php
                    ...
                    while($row_danhmuc=$query_danhmuc->fetch(PDO::FETCH_ASSOC)){
                ?>
    ...
    <tr>
        ...
        <td colspan="2"><input class="btn btn-primary mx-2" type="submit" value="Thêm sản phẩm" name="themsanpham"></td>
    </tr>
</form>
 </table>