<?php
    ...
    $result_lietke_dh= $db->prepare($sql_lietke_dh);
    $result_lietke_dh->execute();
?>
    ...
    while($row=$result_lietke_dh->fetch(PDO::FETCH_BOTH)){
     ...
     <tr>
    	...
    	?>
         ...
         <td>
            <a class="btn btn-primary mx-2" href="index.php?action=quanlydonhang&query=xemdonhang&code=<?php echo $row['code_cart']?>">Xem đơn hàng</a>|
