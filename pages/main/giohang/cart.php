       ...
       <?php
        ...
        ?>
               <tr>
                   ...
                   <td><a class="btn btn-primary mx-2" href="pages/main/giohang/xoasanpham.php?xoa=<?php echo $cart_item['id'] ?>">XÓA</a></td>
               </tr>
           <?php
            }
            ?>
           <tr>
               <td colspan="8">
                   ...
                   <?php
                    ...
                    ?>
                       <p><a class="btn btn-primary mx-2" href="index.php?quanly=dangnhap">Đăng nhập đặt hàng</a></p>
                   <?php
                    }
                    ?>
               </td>
